import { HF_APP_CREDENTIALS, HighFiveDSApi } from 'src/app/nw-object/url/url';
...
export class AuthenticationService {
  ...
  public isAuthenticated(): Promise<HighFiveUser> {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http.post(HighFiveDSApi.USER_VERIFY, { tk: token }, { headers: HF_APP_CREDENTIALS, responseType: 'json' }).subscribe(
        (user: HighFiveUser) => {
