...
import { HF_APP_CREDENTIALS, HighFiveDSApi } from '../nw-object/url/url';
...
export class UserService {
  ...
  public login(uid: string, pswd: string): Promise<void> {
    return new Promise((resolve, reject) => {
      this.http.post(HighFiveDSApi.USER_LOGIN, { uid: uid, pswd: pswd }, { headers: HF_APP_CREDENTIALS, responseType: 'text' }).subscribe(
        (tk: string) => {
